...
import StayEase from "./StayEase.png"
...
export const assets = {
    ...
    totalBookingIcon,
    totalRevenueIcon,
    shareIcon: searchIcon, // Fallback icon
}
...
// Facility Icons - using already imported variables (no circular reference)
...
// NOTE: All data now comes from the backend API
// - Users: Clerk authentication + PostgreSQL
// - Hotels: Created by admin users via /api/hotels endpoint
// - Rooms: Created by hotel owners via /api/rooms endpoint
// - Bookings: Created by users via /api/bookings endpoint
