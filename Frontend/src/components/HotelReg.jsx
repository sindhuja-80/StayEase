...
```
  ...
  >
    ...
    <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
      ...
      <div className="w-full mt-4">
        <label className="font-medium text-gray-500">Hotel Address</label>
        <input
          type="text"
          placeholder="Type here"
          className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light"
      ...
      <div className="w-full mt-4 max-w-60 mr-auto">
        ...
        <select
          className="border border-gray-200 rounded w-full py-2.5 mt-1 outline-indigo-500 font-light mb-2"
          required
          value={city}
      ...
      <button className="bg-indigo-500 hover:bg-indigo-600 transition-all text-white mr-auto px-6 py-2 rounded cursor-pointer">
        Register
      </button>
